<template>
  <ion-page>
    ...
    <ion-content :fullscreen="true" class="ride-content">
      ...
      <ion-card v-if="!rideCompleted && DriverequestVisible" color="white">
        <ion-card-header>
        ...
        <ion-card-content>
          ...
          <div class="button-group" v-if="!rideAccepted">
            <ion-button @click="acceptRide">Accept</ion-button>
            <ion-button @click="declineRide" color="danger">Decline</ion-button>
          </div>
          ...
          <div class="button-group" v-if="rideStarted">
            <ion-button @click="completeRide" color="success">Complete Ride</ion-button>
          </div>
        </ion-card-content>
      </ion-card>
